...
Be specific. "Task 3 creates a new RequestBody struct but src/server/types.ts already has ExecuteRequest that serves the same purpose" is useful. "Watch out for duplication" is not.
